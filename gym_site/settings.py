...
ALLOWED_HOSTS = ['gym-ova0.onrender.com', 'localhost', '127.0.0.1']
CSRF_TRUSTED_ORIGINS = [
    'https://gym-ova0.onrender.com',
]
...
# For production static file handling
...
CLOUDINARY_STORAGE = {
    ...
    'MAX_FILE_SIZE': 104857600,  # 100 MB — adjust as needed
}